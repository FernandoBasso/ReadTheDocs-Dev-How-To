;; Ensures that socks-and-sexprs.lisp and the testing library are
;; always loaded.
(eval-when (:compile-toplevel :load-toplevel :execute)
  (load "socks-and-sexprs")
  (ql:quickload :fiveam))

;; Defines the testing package with symbols from socks-and-sexprs and
;; FiveAM in scope. The `run-tests` function is exported for use by
;; both the user and test-runner
